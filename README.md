...
* `gcp/` `<payload>` represents the UUID of the Ground Control Point that was attached as tag to an OSM Object
...
The `<type indicator>` can consist of the following values in this case:
